    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">LHR Padel</small></h1>
            </div>
            <!-- Nav tabs -->
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="prod-model" placeholder="Descripción"></textarea>    
                              </div>
                              <div class="form-group">
