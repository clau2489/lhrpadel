                            ...
                            if(!$_SESSION['nombreUser']=="" &&!$_SESSION['claveUser']==""){
                                ...
                                echo '
                                    ...
                                    <p>
                                        ...
                                        y contraseña con la cual te registraste en LHRPadel</span>.
                                    </p>
                                    <br>
                                  ...
                                  <div class="form-group">
                                    <div class="input-group">
                                      ...
                                      <input class="form-control all-elements-tooltip" type="password" placeholder="Introdusca su contraseña" required name="clien-pass" data-toggle="tooltip" data-placement="top" title="Introduzca su contraseña">
                                    </div>
                                  </div>
