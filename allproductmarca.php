    ...
    <div id="store" class="container-fluid">
      <div class="row">
          ...
          <div class="col-md-10 products">
              ...
              $TotalReg = $conetar->query("SELECT * FROM producto WHERE CodigoCat='$cod' AND Marca='$id'");
              ...
              //Consulta SQL
              $consultavistas ="SELECT * FROM producto WHERE CodigoCat='$cod' AND Marca='$id' LIMIT ".(($compag-1)*$CantidadMostrar)." , ".$CantidadMostrar."";
              ...
              while ($lista=$consulta->fetch_row()) {
                ...
                echo "
                  ...
                  <img style='width: 97%;' src='assets/img-products/".$imagen."'>
                  ...
                  <button value='".$lista[0]."' class='btn btn-primary btn-block btn-sm botonCarrito'>
              ...
              //echo "<a href=\"?id=".$id."&cod=".$cod."&pag=".$DecrementNum."\">◀ Anterior </a>";
             ...
             for($i=$Desde; $i<=$Hasta;$i++){
              ...
              if($i<=$TotalRegistro){
                ...
                if($i==$compag){
                   echo "<a class='paginator' href=\"?id=".$id."&cod=".$cod."&pag=".$i."\">".$i."</a>";
                }
...
<script src="css/masonry.pkgd.min.js">
$('.products').masonry({
  // options
