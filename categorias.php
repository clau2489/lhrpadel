    ...
    <div id="store" class="container-fluid">
      <div class="row">
          ...
          <div class="col-md-10 products">
              ...
              $TotalReg = $conetar->query("SELECT * FROM producto WHERE CodigoCat='$id'");
              ...
              //Consulta SQL
              $consultavistas ="SELECT * FROM producto WHERE CodigoCat='$id' LIMIT ".(($compag-1)*$CantidadMostrar)." , ".$CantidadMostrar;
              ...
              while ($lista=$consulta->fetch_row()) {
                ...
                echo "
                  ...
                  <img style='width: 98%;' src='assets/img-products/".$imagen."'>
              ...
              //echo "<a href=\"?id=".$id."&pag=".$DecrementNum."\">◀ Anterior </a>";
             ...
             for($i=$Desde; $i<=$Hasta;$i++){
              ...
              if($i<=$TotalRegistro){
                ...
                if($i==$compag){
                   echo "<a class='paginator active' href=\"?id=".$id."&pag=".$i."\">".$i."</a>";
                }

                else {
                  echo "<a class='paginator' href=\"?id=".$id."&pag=".$i."\">".$i."</a>";
                }         
              }
             }
          echo "
